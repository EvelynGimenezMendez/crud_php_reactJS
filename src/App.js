  ...
  return (
    <div style={{textAlign:'center'}}>
      ...
      <Modal isOpen={modalEditar}>
        ...
        <ModalBody>
          <div className='form-group'>
            <label>Nombre: </label>
            <br/>
            <input type='text' className='form-control' name='nombre' onChange={handleChange} value={frameworkSeleccionado?.nombre}/>
            <br/>
            <label>Lanzamiento: </label>
            <input type='text' className='form-control' name='lanzamiento'onChange={handleChange} value={frameworkSeleccionado?.lanzamiento}/>
            <br/>
            <label>Desarrollador: </label>
            <br/>
            <input type='text' className='form-control' name='desarrollador'onChange={handleChange} value={frameworkSeleccionado?.desarrollador}/>
            <br/>
          </div>
        </ModalBody>
        <ModalFooter>
      ...
      <Modal isOpen={modalEliminar}>
        <ModalBody>
          ¿Estas seguro que deseas eliminar el framework {frameworkSeleccionado?.nombre}?
        </ModalBody>
        <ModalFooter>
